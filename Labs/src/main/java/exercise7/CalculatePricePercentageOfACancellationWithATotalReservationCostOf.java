...
public class CalculatePricePercentageOfACancellationWithATotalReservationCostOf {
	...
	public CalculatePricePercentageOfACancellationWithATotalReservationCostOf(int totalCostOfTheReservation) {
